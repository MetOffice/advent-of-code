...
from segments import main_part_1, count_unique_segments, parse_display_code
...
def test_parse_display_code():
    ...
    expected_definition = ["be", "cfbegad", "cbdgef", "fgaecd", "cgeb", "fdcge", "agebfd", "fecdb", "fabcd", "edb"]
